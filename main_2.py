...
cap = cv2.VideoCapture(r'\Users\Usuario\Documents\GitHub\yolo_tracking\input\filtro_corto.mp4')  
...
while True:
    ...
    # Detección con YOLO
    results = model.predict(frame, classes=CLASS_IDS, conf=0.1)  
